    ...
    <>
      <div style={{ width: '100%', height: '100%', position: 'fixed' }}>
        <Toolbar style={{ backgroundColor: 'black' }}>
          ...
          <div style={{ display: 'flex', marginLeft: 'auto', cursor: 'pointer' }} onClick={LogoutFunction}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row' }} >
          ...
          <div style={{
            ...
            <List style={{ display: 'flex', backgroundColor: 'black', flexDirection: 'column', width: 200, height: '100vh', borderWidth: 1, borderRight: 1, borderRightWidth: 1, borderRightColor: 'white' }}>
              {ListValues.map((text, index) => (
                <>
                <ListItem key={text} disablePadding style={{ transition: 'background-color 0.2s' }} onMouseOver={(e) => e.currentTarget.style.backgroundColor = '#393A3B'} onMouseOut={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
          ...
          </div>    <div style={{ width: '80%', justifyContent: 'center', backgroundColor: '#F7FAFC', alignItems: 'center', height: '80%', marginRight: 'auto', marginBottom: 40 }}>
            <ListPage /></div>
